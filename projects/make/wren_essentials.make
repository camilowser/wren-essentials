...
TARGETDIR = ../../lib
TARGET = $(TARGETDIR)/libwren_essentials.so
...
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -shared -Wl,-soname=libwren_essentials.so -s
...
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib32 -m32 -shared -Wl,-soname=libwren_essentials.so -s
...
ALL_LDFLAGS += $(LDFLAGS) -shared -Wl,-soname=libwren_essentials.so -s

else ifeq ($(config),debug_64bit)
TARGETDIR = ../../lib
TARGET = $(TARGETDIR)/libwren_essentials_d.so
...
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -shared -Wl,-soname=libwren_essentials_d.so
...
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib32 -m32 -shared -Wl,-soname=libwren_essentials_d.so
